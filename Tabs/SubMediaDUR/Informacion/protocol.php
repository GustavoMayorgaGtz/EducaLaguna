...
$consulta = "SELECT Descripcion, Titulo FROM tbprotocolo AS protocolo INNER JOIN tbcontenido AS contenido  ON protocolo.IdProtocolo = {$opcion} and contenido.IdProtocolo = {$opcion};";
