...
$consulta = "SELECT Descripcion, Titulo, URLVideo FROM tbprotocolo AS protocolo INNER JOIN tbcontenido AS contenido  ON protocolo.IdProtocolo = 1 and contenido.IdProtocolo = {$opcion};";
